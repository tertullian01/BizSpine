...
class ReviewControllerTest extends DatabaseTestCase
{
    ...
    public function testCreateVerifiedReview()
    {
        ...
        $this->assertEquals(1, $data['verified']); // Should be verified since user purchased
        $this->assertEquals(0, $data['published']); // Should not be published by default
    }
    ...
    public function testCreateUnverifiedReview()
    {
        ...
        $this->assertEquals(201, $response->getStatusCode());
        $this->assertEquals(0, $data['verified']); // Should not be verified
    ...
    public function testGetPublishedReviews()
    {
        ...
        $this->assertCount(1, $data); // Only published review
        $this->assertEquals('Published review', $data[0]['review_text']);
    }
